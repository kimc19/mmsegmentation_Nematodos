    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                resume='allow',
                notes=
                'Entrenamiento modelo bisenetv2 preentrenado, aumentado 2, lr=0.05, m=0.9, A1, 160k iteraciones, batch=4'
            ),
            log_checkpoint=True,
...
log_level = 'INFO'
load_from = 'https://download.openmmlab.com/mmsegmentation/v0.5/bisenetv2/bisenetv2_fcn_ohem_4x4_1024x1024_160k_cityscapes/bisenetv2_fcn_ohem_4x4_1024x1024_160k_cityscapes_20220808_172324-8bf0aaba.pth'
resume_from = None
...
work_dir = '../work_dirs/bisenetv2_A2'
seed = 0
gpu_ids = range(0, 1)
device = 'cuda'
