    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                resume='allow',
                notes=
                'Entrenamiento modelo stdc preentrenado, 80k iteraciones, batch=8, optimizador SGD, lr=0.1, m=0.9'
            ),
            log_checkpoint=True,
...
log_level = 'INFO'
load_from = '../checkpoints/stdc1_in1k-pre_512x1024_80k_cityscapes_20220224_141648-3d4c2981.pth'
resume_from = None
