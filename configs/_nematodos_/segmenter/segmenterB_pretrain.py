    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                project='Nematodos',
                name='segmenterB_pretrain',
                id='segmenterB_pretrain',
                resume='allow',
                notes=
                'Entrenamiento modelo segmenterB pretrain, batch=1, lr=0.001, m=0.9, 160k iter'
            ),
            log_checkpoint=True,
...
work_dir = '../work_dirs/segmenterB_pretrain'
seed = 0
gpu_ids = range(0, 1)
device = 'cuda'
