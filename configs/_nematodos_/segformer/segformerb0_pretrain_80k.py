    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                project='Nematodos',
                name='segformerb0_pretrain_80k',
                id='segformerb0_pretrain_80k',
                resume='allow',
                notes='Entrenamiento modelo segformer preentrenado, batch=1, lr=6e-05, 80k iter'),
            log_checkpoint=True,
...
work_dir = '../work_dirs/segformerb0_pretrain_80k'
seed = 0
gpu_ids = range(0, 1)
device = 'cuda'
