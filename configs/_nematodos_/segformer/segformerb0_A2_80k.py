    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                project='Nematodos',
                name='segformerb0_A2_80k',
                id='segformerb0_A2_80k',
                resume='allow',
                notes=
                'Entrenamiento modelo segformer b0, preentrenado, aumentado 2, batch=1, lr=6e-05, 80k iter'
            ),
            log_checkpoint=True,
...
work_dir = '../work_dirs/segformerb0_A2_80k'
seed = 0
gpu_ids = range(0, 1)
device = 'cuda'
