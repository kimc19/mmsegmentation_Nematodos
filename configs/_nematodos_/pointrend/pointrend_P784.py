...
model = dict(
    ...
    train_cfg=dict(
        num_points=784, oversample_ratio=3, importance_sample_ratio=0.75),
    test_cfg=dict(
        mode='whole',
        subdivision_steps=2,
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                resume='allow',
                notes=
                'Entrenamiento modelo pointrend base, puntos 784, lr=0.01, m=0.9, A1, 30k iteraciones, batch=2'
            ),
            log_checkpoint=True,
...
work_dir = '../work_dirs/PointRend_P784'
seed = 0
gpu_ids = range(0, 1)
device = 'cuda'
