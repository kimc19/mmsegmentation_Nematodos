    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                resume='allow',
                notes=
                'Entrenamiento modelo pointrend preentrenado, aumentado 2, lr=0.01, m=0.9, A1, 80k iteraciones, batch=2'
            ),
            log_checkpoint=True,
...
log_level = 'INFO'
load_from = 'https://download.openmmlab.com/mmsegmentation/v0.5/point_rend/pointrend_r101_512x1024_80k_cityscapes/pointrend_r101_512x1024_80k_cityscapes_20200711_170850-d0ca84be.pth'
resume_from = None
...
work_dir = '../work_dirs/PointRend_A2'
seed = 0
gpu_ids = range(0, 1)
device = 'cuda'
