...
model = dict(
    ...
    train_cfg=dict(
        num_points=3136, oversample_ratio=3, importance_sample_ratio=0.75),
    test_cfg=dict(
        mode='whole',
        subdivision_steps=2,
        subdivision_num_points=6272,
        scale_factor=2))
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                resume='allow',
                notes=
                'Entrenamiento modelo pointrend base, puntos= P3136, lr=0.01, m=0.9, A1, 80k iteraciones, batch=2'
            ),
            log_checkpoint=True,
...
log_level = 'INFO'
load_from = None
resume_from = '../work_dirs/PointRend_P3136/latest.pth'
...
work_dir = '../work_dirs/PointRend_P3136'
seed = 0
gpu_ids = range(0, 1)
device = 'cuda'
