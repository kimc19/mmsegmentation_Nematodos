...
cfg.work_dir = '../work_dirs/segmenterS'
    ...
    hooks=[
        ...
        dict(type='MMSegWandbHook',
             ...
             init_kwargs={
                 ...
                 'project': 'Nematodos',
                 'name': 'segmenterS_base',
                 'id': 'segmenterS_base',
                 'resume': 'allow',
                 'notes':'Entrenamiento modelo segmenterS base, aumentado 2, batch=1, lr=0.001, m=0.9, 160k iter'
                 },
             log_checkpoint=True,
...
cfg.dump("../configs/_nematodos_/segmenter/segmenterS_base.py")
