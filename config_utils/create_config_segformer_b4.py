...
parser = argparse.ArgumentParser(description='Generador de config files para el modelo segformer b4.')
...
cfg = Config.fromfile('../configs/segformer/segformer_mit-b4_8x1_1024x1024_160k_cityscapes.py')
...
cfg.work_dir = '../work_dirs/segformerb4_A2'
...
cfg.load_from = 'https://download.openmmlab.com/mmsegmentation/v0.5/segformer/segformer_mit-b4_8x1_1024x1024_160k_cityscapes/segformer_mit-b4_8x1_1024x1024_160k_cityscapes_20211207_080709-07f6c333.pth'
    ...
    hooks=[
        ...
        dict(type='MMSegWandbHook',
             ...
             init_kwargs={
                 ...
                 'id': 'segformerb4_A2',
                 'resume': 'allow',
                 'notes':'Entrenamiento modelo segformer b4 pretrain, aumentado 2, batch=1, lr=6e-0.5, 160k iter'
                 },
             log_checkpoint=True,
...
cfg.dump("../configs/_nematodos_/segformer/segformerb4_A2.py")
