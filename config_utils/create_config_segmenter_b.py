...
parser = argparse.ArgumentParser(description='Generador de config files para el modelo segmenter base.')
...
cfg.work_dir = '../work_dirs/segmenterB_A2'
...
cfg.load_from = 'https://download.openmmlab.com/mmsegmentation/v0.5/segmenter/segmenter_vit-b_mask_8x1_512x512_160k_ade20k/segmenter_vit-b_mask_8x1_512x512_160k_ade20k_20220105_151706-bc533b08.pth'
    ...
    hooks=[
        ...
        dict(type='MMSegWandbHook',
             ...
             init_kwargs={
                 ...
                 'id': 'segmenterB_A2',
                 'resume': 'allow',
                 'notes':'Entrenamiento modelo segmenterB pretrain, aumentado 2, batch=1, lr=0.001, m=0.9, 160k iter'
                 },
             log_checkpoint=True,
...
cfg.dump("../configs/_nematodos_/segmenter/segmenterB_A2.py")
