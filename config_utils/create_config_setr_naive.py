...
parser = argparse.ArgumentParser(description='Generador de config files para el modelo setr naive.')
...
cfg = Config.fromfile('../configs/setr/setr_naive_512x512_160k_b16_ade20k.py')
...
cfg.work_dir = '../work_dirs/SetrNaive'
...
cfg.log_config = dict(
    ...
    hooks=[
        ...
        dict(type='MMSegWandbHook',
             ...
             init_kwargs={
                 'entity': 'kimc19',
                 'project': 'SetrNaive_Nematodos',
                 'name': 'SetrNaive_base',
                 'id': 'SetrNaive_base',
                 'resume': 'allow',
                 'notes':'Entrenamiento modelo SetrNaive'
                 },
             log_checkpoint=True,
...
cfg.dump("../configs/_nematodos_/setr/SetrNaive_base.py")
