...
parser = argparse.ArgumentParser(description='Generador de config files para el modelo segformer b2.')
...
cfg = Config.fromfile('../configs/segformer/segformer_mit-b2_8x1_1024x1024_160k_cityscapes.py')
...
cfg.work_dir = '../work_dirs/segformerb2_A2'
...
cfg.load_from = 'https://download.openmmlab.com/mmsegmentation/v0.5/segformer/segformer_mit-b2_8x1_1024x1024_160k_cityscapes/segformer_mit-b2_8x1_1024x1024_160k_cityscapes_20211207_134205-6096669a.pth'
    ...
    hooks=[
        ...
        dict(type='MMSegWandbHook',
             ...
             init_kwargs={
                 ...
                 'id': 'segformerb2_A2',
                 'resume': 'allow',
                 'notes':'Entrenamiento modelo segformer pretrain, aumentado 2, batch=1, lr=6e-05, 160k iter'
                 },
             log_checkpoint=True,
...
cfg.dump("../configs/_nematodos_/segformer/segformerb2_A2.py")
