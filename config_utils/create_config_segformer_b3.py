...
cfg = Config.fromfile('../configs/segformer/segformer_mit-b3_8x1_1024x1024_160k_cityscapes.py')
...
cfg.work_dir = '../work_dirs/segformerb3_A2'
    ...
    hooks=[
        ...
        dict(type='MMSegWandbHook',
             ...
             init_kwargs={
                 ...
                 'id': 'segformerb3_A2',
                 'resume': 'allow',
                 'notes':'Entrenamiento modelo segformer b3 pretrain, aumentado 2, batch=1, lr=6e-05, 160k iter'
                 },
             log_checkpoint=True,
...
cfg.dump("../configs/_nematodos_/segformer/segformerb3_A2.py")
