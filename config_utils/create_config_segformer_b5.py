...
parser = argparse.ArgumentParser(description='Generador de config files para el modelo segformer b5.')
...
cfg = Config.fromfile('../configs/segformer/segformer_mit-b5_8x1_1024x1024_160k_cityscapes.py')
...
cfg.work_dir = '../work_dirs/segformerb5_base'
...
#cfg.load_from = 'https://download.openmmlab.com/mmsegmentation/v0.5/segformer/segformer_mit-b3_8x1_1024x1024_160k_cityscapes/segformer_mit-b3_8x1_1024x1024_160k_cityscapes_20211206_224823-a8f8a177.pth'
    ...
    hooks=[
        ...
        dict(type='MMSegWandbHook',
             ...
             init_kwargs={
                 ...
                 'project': 'Nematodos',
                 'name': 'segformerb5_base',
                 'id': 'segformerb5_base',
                 'resume': 'allow',
                 'notes':'Entrenamiento modelo segformer b5 base'
                 },
             log_checkpoint=True,
...
cfg.dump("../configs/_nematodos_/segformer/segformerb5_base.py")
