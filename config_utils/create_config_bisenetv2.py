...
parser = argparse.ArgumentParser(description='Generador de config files para el modelo bisenetv2.')
...
cfg = Config.fromfile('../configs/bisenetv2/bisenetv2_fcn_ohem_4x4_1024x1024_160k_cityscapes.py')
...
cfg.work_dir = '../work_dirs/bisenetv2_A2'
...
cfg.log_config = dict(
    interval=16000,
    hooks=[
        dict(type='TextLoggerHook', by_epoch=False, interval=4000),
        dict(type='MMSegWandbHook',
             ...
             init_kwargs={
                 ...
                 'id': 'bisenetv2_A2',
                 'resume': 'allow',
                 'notes':'Entrenamiento modelo bisenetv2 preentrenado, aumentado 2, lr=0.05, m=0.9, A1, 160k iteraciones, batch=4'
                 },
             log_checkpoint=True,
...
cfg.dump("../configs/_nematodos_/bisenetv2/bisenetv2_A2.py")
