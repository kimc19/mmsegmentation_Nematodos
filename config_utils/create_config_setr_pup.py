...
parser = argparse.ArgumentParser(description='Generador de config files para el modelo setr pup.')
...
cfg = Config.fromfile('../configs/setr/setr_pup_512x512_160k_b16_ade20k.py')
...
cfg.work_dir = '../work_dirs/SetrPUP'
...
cfg.dump("../configs/_nematodos_/setr/SetrPUP_base.py")
