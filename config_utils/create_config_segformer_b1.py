...
parser = argparse.ArgumentParser(description='Generador de config files para el modelo segformer b1.')
...
cfg = Config.fromfile('../configs/segformer/segformer_mit-b1_8x1_1024x1024_160k_cityscapes.py')
...
cfg.work_dir = '../work_dirs/segformerb1'
...
cfg.dump("../configs/_nematodos_/segformer/segformerb1_base.py")
