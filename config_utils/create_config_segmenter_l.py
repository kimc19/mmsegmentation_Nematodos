...
parser = argparse.ArgumentParser(description='Generador de config files para el modelo segmenter large.')
...
cfg = Config.fromfile('../configs/segmenter/segmenter_vit-l_mask_8x1_640x640_160k_ade20k.py')
...
cfg.work_dir = '../work_dirs/segmenterL_A2'
...
cfg.load_from = 'https://download.openmmlab.com/mmsegmentation/v0.5/segmenter/segmenter_vit-l_mask_8x1_640x640_160k_ade20k/segmenter_vit-l_mask_8x1_640x640_160k_ade20k_20220614_024513-4783a347.pth'
    ...
    hooks=[
        ...
        dict(type='MMSegWandbHook',
             ...
             init_kwargs={
                 ...
                 'id': 'segmenterL_A2',
                 'resume': 'allow',
                 'notes':'Entrenamiento modelo segmenterL pretrain, aumentado 2, batch=1, lr=0.001, m=0.9, 160k iter'
                 },
             log_checkpoint=True,
...
cfg.dump("../configs/_nematodos_/segmenter/segmenterL_A2.py")
